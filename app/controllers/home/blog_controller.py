...
def index():
    ...
    return render_template("home/blog/index.html", category_list=category_list, tag_list=tag_list,
...
def article_list_all():
    ...
    tag_list = TagAPIService.get_tag_list()
    article_list = ArticleAPIService.get_article_list()
    return render_template("home/blog/list.html",
...
def article_detail(article_id):
    ...
    return render_template("home/blog/detail.html",
